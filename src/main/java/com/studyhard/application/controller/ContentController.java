...
public class ContentController {
  ...
  public ResponseEntity<ApiResponse<ContentDto>> createContent(@RequestBody CreateContentRequest createContentRequest){
  ...
  public ResponseEntity<ApiResponse<ContentSummaryDto>> reviewContent(@PathVariable("contentId") String contentId) {
